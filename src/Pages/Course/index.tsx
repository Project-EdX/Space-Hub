...
const courses = [
  ...
  {
    title: 'CSS Mastery',
    description: 'Learn to use CSS selectors and properties to stylize your HTML pages.',
...
const seasons = [
  {
    ...
    description: 'Master HTML, CSS, and JavaScript in this foundational season.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <h1 className="font-orbitron text-2xl text-neon-blue">CodeVerse</h1>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg md:text-xl max-w-3xl mx-auto">
              Embark on a coding journey through interactive courses and gamified learning
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {courses.map((course) => (
                <CourseCard
                  key={course.title}
                  {...course}
                  onClick={() => console.log(`Selected course: ${course.title}`)}
                />
              ))}
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {seasons.map((season) => (
                <SeasonCard
                  key={season.number}
                  {...season}
                  onClick={() => console.log(`Selected season: ${season.number}`)}
                />
              ))}
            </div>
          </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li>
                  <a href="#" className="hover:text-white transition-colors">Seasons</a>
                </li>
                <li>
