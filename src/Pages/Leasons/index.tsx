...
import { ChevronDown, ChevronUp, User, Trophy, Star, MessageSquare, Code2, Gamepad2, Compass, Ghost, Brain, Target } from 'lucide-react';
...
const chapters: Chapter[] = [
  {
    id: 1,
    name: 'Elements',
    description: 'Create your first web page by learning about basic elements and tags.',
    exercises: [
            ...
            <div className="p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-[#1E2231] rounded-lg">
                    {game.icon}
                  </div>
                  <div>
                    <h3 className="text-lg font-pressStart mb-1">{game.name}</h3>
                    <div className="flex items-center gap-2">
                      <span className={`text-xs px-2 py-1 rounded font-pressStart
                        ${game.difficulty === 'Easy' ? 'bg-green-500/20 text-green-400' :
                          game.difficulty === 'Medium' ? 'bg-yellow-500/20 text-yellow-400' :
                          'bg-red-500/20 text-red-400'}`}>
                        {game.difficulty}
                      </span>
                      <span className="text-xs text-gray-400 font-pressStart">{game.xp} XP</span>
                    </div>
                  </div>
                </div>
              </div>
              <p className="text-gray-400 text-sm mb-4 font-pressStart">{game.description}</p>
              <motion.button
          ...
          <div className="flex flex-col gap-8">
            <div className="flex items-center gap-8">
              ...
              <div>
                ...
                >
                  Create your first website with HTML, the building blocks of the web and
              ...
              <div className="max-w-5xl mx-auto px-4">
                <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        >
                          ...
                          >
                            ...
                            <div className="flex-grow">
                              <div className="flex items-center gap-2">
                                <h3 className="text-lg font-pressStart">{chapter.name}</h3>
                                {chapter.isClub && (
                                  <span className="text-xs px-2 py-1 rounded bg-purple-500 font-pressStart">Club</span>
                                )}
                              </div>
                            </div>
                            <motion.div
                          ...
                          <AnimatePresence>
                            {expandedChapter === chapter.id && chapter.exercises.length > 0 && (
                              <motion.div
                              ...
                              >
                                <div className="p-4 bg-[#0D0F17]">
                                  <p className="text-gray-400 mb-4 font-pressStart text-sm">{chapter.description}</p>
                                    ...
                                    {chapter.exercises.map((exercise) => (
                                      ...
                                      >
                                        <div className="flex items-center gap-3">
                                          <span className="text-gray-500 font-pressStart text-xs">Exercise {exercise.id}</span>
                                          <span className="text-white font-pressStart text-xs">{exercise.name}</span>
                                        </div>
                                        <motion.button
                                          ...
                                          disabled={exercise.status !== 'Start'}
                                          whileHover={{ scale: exercise.status === 'Start' ? 1.05 : 1 }}
                                          whileTap={{ scale: exercise.status === 'Start' ? 0.95 : 1 }}
                                        >
                                          {exercise.status}
                                        </motion.button>
                                      </motion.div>
                  ...
                  <div className="lg:w-1/3 space-y-6">
                    ...
                    >
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-400 font-pressStart">Level 1</p>
                        </div>
                      </div>
                      <motion.button 
                    ...
                    >
                      <h3 className="font-pressStart text-sm mb-4">Course Progress</h3>
                      <div className="space-y-4">
                        <div>
                          <div className="flex justify-between text-xs mb-2 font-pressStart">
                            <span className="text-gray-400">Exercises</span>
                            <span>{progress.exercises.completed}/{progress.exercises.total}</span>
                          </div>
                        ...
                        <div>
                          <div className="flex justify-between text-xs mb-2 font-pressStart">
                            ...
                            <span>{progress.projects.completed}/{progress.projects.total}</span>
                          </div>
                          <div className="h-2 bg-[#1E2231] rounded-full overflow-hidden progress-bar">
                            <div 
                              className="h-full bg-[#0099ff]"
                        ...
                        <div>
                          <div className="flex justify-between text-xs mb-2 font-pressStart">
                            ...
                            <span>{progress.xp.earned}/{progress.xp.total}</span>
                          </div>
                          <div className="h-2 bg-[#1E2231] rounded-full overflow-hidden progress-bar">
                            <div 
                              className="h-full bg-[#0099ff]"
                    ...
                    <motion.div 
                      ...
                      transition={{ delay: 0.2 }}
                    >
                      <h3 className="font-pressStart text-sm mb-2">Course Badges</h3>
                      <p className="text-xs text-gray-400 mb-4 font-pressStart">Complete a chapter to earn a badge – collect 'em all!</p>
                    ...
                    >
                      <h3 className="font-pressStart text-sm mb-2">Need HTML Help?</h3>
                      <p className="text-xs text-gray-400 mb-4 font-pressStart">Ask questions in our community!</p>
                      <motion.button 
